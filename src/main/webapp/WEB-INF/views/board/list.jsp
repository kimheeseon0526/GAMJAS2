...
<div class="clearfix py-0 row align-items-center mb-3">
  <div class="col-2">
    <select class="form-select form-select-sm border-success-subtle">
  ...
  <form class="col input-group search-form">
    <select class="form-select form-select-sm border-success-subtle" name="type">
    ...
    <input type="text" class="form-control form-control-sm w-75 border-success-subtle"
  ...
  <div class="col-2">
    <a href="write?${pageDto.cri.qs2}" class="btn btn-success btn-sm float-end">
...
<ul class="pagination pagination-sm justify-content-center mt-4">
  <c:if test="${pageDto.doubleLeft}">
    <li class="page-item">
      <a class="page-link text-success" href="list?page=1&${pageDto.cri.qs}">
  ...
  <c:if test="${pageDto.left}">
    <li class="page-item">
      <a class="page-link text-success" href="list?page=${pageDto.start - 1}&${pageDto.cri.qs}">
  ...
  <c:forEach begin="${pageDto.start}" end="${pageDto.end}" var="i">
    <li class="page-item ${pageDto.cri.page == i ? 'active' : ''}">
      <a class="page-link" href="list?page=${i}&${pageDto.cri.qs}">${i}</a>
    </li>
  </c:forEach>

  <c:if test="${pageDto.right}">
    <li class="page-item">
      <a class="page-link text-success" href="list?page=${pageDto.end + 1}&${pageDto.cri.qs}">
  ...
  <c:if test="${pageDto.doubleRight}">
    <li class="page-item">
      <a class="page-link text-success" href="list?page=${pageDto.realEnd}&${pageDto.cri.qs}">
